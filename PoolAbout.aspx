...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <font color="red">
        ...
        ** Note: You must use the official mining software to mine biblepay located <a href=https://wiki.biblepay.org/Upgrade_to_RandomX>here</a> (Otherwise you will not be compensated for BiblePay shares).
