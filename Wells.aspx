<%@ Page Title="Custom Dug Water Wells" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Wells.aspx.cs" Inherits="Saved.Wells"%>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2>BiblePay - Custom Dug Wells for Children in Pakistan Project</h2>
    <br />

    <h3>Providing 19 Wells for children in Pakistan with fresh water!</h3>
    <br />
    

    Our compassionate community has donated the funds for the construction of wells in villages of Pakistan that will perpetually provide water for up to 600 children per well (thats up to 7,800 kids!) with no future monthly land fees, or water bills!  
    
    <p>    This is Unlimited water provided by GOD!
        <p>
        We partnered with <a href=https://www.paaniproject.org />Paani Project</a> to accomplish this project.
            <p>
        We have placed pictures of the Site Location, the Community Plaque for dedication in honor of BiblePay, the Handover pictures to the community, and in some cases the Dedication movie clip (NOTE that we did not always receive a movie clip for each well).
                <p>
        Please enjoy our project below:



        <h3>Well #1 - August 2020</h3>
    <br />
...
<hr />
   ...
   <br />
    ...
    <h3>Well #20 - November 2021</h3><!--ph3.1-->
    <br />
    
        Site Selection:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/selection1.JPG" />
        <br>
    
        Handover:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover1.JPG" />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover12.JPG" />
        <br />
        Water Test:
        <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/watertest1.JPG" />
    <br />
    ...
    <h3>Well #21 - November 2021</h3><!--ph3.1-->
    <br />
    
        Site Selection:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/selection2.JPG" />
        <br>
    
        Handover:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover2.JPG" />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover22.JPG" />
        <br />
        Water Test:
        <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/waterreport2.jpeg" />
    <br />
    



    <h3>Well #22.0 - November 2021</h3><!--ph3.1-->
    <br />
    
        Site Selection:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/selection3.JPG" />
        <br>
    
        Handover:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover3.JPG" />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover32.JPG" />
        <br />
    <br />
   ...
   <br />
    ...
    <h3>Well #23 - November 2021</h3><!--ph3.1-->
    <br />
    
        Site Selection:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/selection4.JPG" />
        <br>
    
        Handover:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover4.JPG" />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover42.JPG" />
        <br />
    <br />
    

    <h3>Well #24 - November 2021</h3>
    <br />
    
        Site Selection:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/selection5.JPG" />
        <br>
    
        Handover:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover5.JPG" />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover52.JPG" />
        <br />
    <br />


    <h3>Well #25 - November 2021</h3>
    <br />
    
        Site Selection:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/selection6.JPG" />
        <br>
    
        Handover:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover6.JPG" />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover62.JPG" />
        <br />
    <br />
    ...
    <h3>Well #26 - November 2021</h3><!--ph3.1-->
    <br />
    
        Site Selection:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/selection7.jpeg" />
        <br>
    
        Handover:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover7.JPG" />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover72.JPG" />
        <br />
        Water Test:
        <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/waterreport7.JPG" />
    <br />
    
        Dedication:
   <br />
        <img width=500 height=350 style='vertical-align:top' src="https://foundation.biblepay.org/Images/Wells3/plaque7.JPG" />
        <video width='500' height='350' style='background-color:black' controls>      
            <source src="https://foundation.biblepay.org/Images/Wells3/dedication7.MP4" type='video/mp4' />   
        </video>



    <h3>Well #27 - November 2021</h3>
    <br />
    
        Site Selection:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/selection8.JPG" />
        <br>
    
        Handover:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover8.JPG" />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover82.JPG" />
        <br />
    <br />
       Water Test:
        <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/watertest8.jpg" />
        Dedication:
   <br />
        <video width='500' height='350' style='background-color:black' controls>      
            <source src="https://foundation.biblepay.org/Images/Wells3/dedication8.MP4" type='video/mp4' />   
        </video>

    


    <h3>Well #28 - November 2021</h3><!--ph3.1-->
    <br />
    
        Site Selection:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/selection9.JPG" />
        <br>
    
        Handover:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover9.JPG" />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover92.JPG" />
        <br />
        Water Test:
        <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/waterreport9.JPG" />
    <br />
    


    <h3>Well #29 - November 2021</h3><!--ph3.1-->
    <br />
    
        Site Selection:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/selection10.jpeg" />
        <br>
    
        Handover:
    <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover10.JPG" />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/handover103.JPG" />
        <br />
        Water Test:
        <br />
        <img width=500 height=250 src="https://foundation.biblepay.org/Images/Wells3/waterreport10.JPG" />
    <br />
    
        Dedication:
   <br />
        <img width=500 height=350 style='vertical-align:top' src="https://foundation.biblepay.org/Images/Wells3/plaque10.JPG" />
        <video width='500' height='350' style='background-color:black' controls>      
            <source src="https://foundation.biblepay.org/Images/Wells3/dedication10.MP4" type='video/mp4' />   
        </video>
