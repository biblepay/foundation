...
namespace NBitcoin
{
    ...
    {
        public static Network BiblepayMain => NetworksContainer.GetNetwork("BiblepayMain") ?? NetworksContainer.Register(new BiblepayMain());
        public static Network BiblepayTest => NetworksContainer.GetNetwork("BiblepayTest") ?? NetworksContainer.Register(new BiblepayTest());
        ...
        public static Network DashMain => NetworksContainer.GetNetwork("DashMain") ?? NetworksContainer.Register(new DashMain());
