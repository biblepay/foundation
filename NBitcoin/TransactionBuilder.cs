...
namespace NBitcoin
{
    ...
    public class TransactionBuilder
    {
        ...
        internal class TransactionBuildingContext
        {
            ...
            {
                this.Builder = builder;
                this.Transaction = builder.Network.Consensus.ConsensusFactory.CreateTransaction();
            ...
            IMoney zero)
        {
            ...
            for(int i = 0; i < builderList.Count; i++)
            {
                if(builderList[i].Target == this._SubstractFeeBuilder)
                {
                    ...
                    newTxOut.sTxOutMessage = new byte[1];
        ...
        {
            if (transaction.Outputs[0].sTxOutMessage == null)
            {
                transaction.Outputs[0].sTxOutMessage = new byte[1];
            }
