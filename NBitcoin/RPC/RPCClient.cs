    ...
    public partial class RPCClient : INBitcoinBlockRepository, IRPCClient
    {
        ...
        static RPCClient()
        {
            ...
            else if (!string.IsNullOrEmpty(localAppData))
            {
                ...
                // biblepay main
                string biblepayFolder = Path.Combine(localAppData, ".biblepayevolution");

                string mainnet1 = Path.Combine(biblepayFolder, ".cookie");
                RegisterDefaultCookiePath(Network.BiblepayMain, mainnet1);
