...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tr><td>    HODL %:          <td>    <asp:TextBox ID="txtHODLPercent" width="200px" readonly runat="server" ></asp:TextBox><small><font color="red"> &nbsp;*Based on actual chain data over 48 hours</font></small>
